...
제네릭 클래스인 MyClass<T>는 제네릭 타입의 변수 1개를 갖고 있다.
이 제네릭 타입은 필드 타입 getter매서드의 리턴 타입 setter매서드의 입력 타입이
사용됐다. 
...
//             mc3.set("안녕"); // 오류 발생 
             System.out.println(mc3.get());
             	/*
				  ...
				  생성할때 정해진 타입으로 확정되기 떄문에 setter매서드를 사용할떄 입력 타입을 정확히 확인할 수도 있고 
